...
plugin_identifier = "mutedgcode"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_mutedgcode"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "Muted GCode"
...
# module
plugin_description = """Silence sending configured and enabled gcode commands."""
...
plugin_url = "https://github.com/jneilliii/OctoPrint-MutedGCode"
